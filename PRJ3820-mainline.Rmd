...
proc_pos = function(REC, OCC,PEG,MET){
  ...
  OS_ffn_stub = "C:/Users/McMillanAn/OneDrive - MWLR/Projects/PRJ3820-DOC-GNSS/data/FINAL_SOLUTIONS/"
...
PPP_RESULTS_FINAL = OCC_TBL %>% left_join(PPP_results_COLL, by = "OCC_UID")
...
if (resave_OCC_TBL){
  OCC_TBL = ANL_TBL %>% filter(MET == "PPK-DNVK") %>% select(!c(1:3))
