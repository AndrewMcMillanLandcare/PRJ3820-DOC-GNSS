...
g= g + geom_point(aes(DEL_LON , DEL_LAT , color = as.character(Q))) + facet_wrap(~Q) + geom_vline(aes(xintercept = 0))+ geom_hline(aes(yintercept = 0))
 
g
g = g + geom_point(data = best_soln, aes(DEL_LON, DEL_LAT), color = "black" )

axlim_abs = 2
axlims = c(-axlim_abs,axlim_abs)
